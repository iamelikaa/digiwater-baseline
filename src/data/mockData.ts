...
export const districts: District[] = [
  ...
  { id: "sperina", name: "Sperina", status: "anomaly", lat: 44.687, lng: 7.69, parentId: "marene" },
  ...
  { id: "cavallermaggiore", name: "Cavallermaggiore", status: "normal", lat: 44.7737, lng: 7.6494 },
