...
Task 02.1 — Top Bar & Navigation (`Study-Materials/Tasks/02_Layout/02.1-shell-layout-prompt.md`)
...
- No new mock data fields or shared data sources were added in Task 01.1.
